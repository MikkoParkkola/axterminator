...
[![License](https://img.shields.io/badge/license-PolyForm--Noncommercial--1.0.0-blue?style=for-the-badge)](LICENSE.md)
...
AXTerminator is licensed under the **PolyForm Noncommercial License 1.0.0** —
free for personal, research, educational, noncommercial, and open-source use with attribution.
